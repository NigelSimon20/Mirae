...
export default function MiraeDownload() {
  ...
  const handleAndroidDownload = useCallback((e: MouseEvent<HTMLAnchorElement>) => {
    e.preventDefault();
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-500 to-purple-700 text-white p-6">
      <motion.div
        ...
        className="text-center p-8 rounded-2xl bg-white/10 backdrop-blur-xl border border-white/20 shadow-xl max-w-lg w-full"
      >
